...
public class HugeSmokeParticles extends TextureSheetParticle {
    protected HugeSmokeParticles(ClientLevel clientLevel, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z,
            ...
            return new HugeSmokeParticles(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
