...
public class VomitParticles extends TextureSheetParticle {
    protected VomitParticles(ClientLevel clientLevel, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z,
            ...
            return new VomitParticles(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
