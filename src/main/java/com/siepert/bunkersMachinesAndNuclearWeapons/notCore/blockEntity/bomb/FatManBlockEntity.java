...
public class FatManBlockEntity extends BlockEntity {
    boolean isExploding;
    int explosionCurrent;
    final int explosionCurrentMax = 256;

    public FatManBlockEntity(BlockPos pPos, BlockState pState) {
        super(ModBlockEntities.FAT_MAN_BE.get(), pPos, pState);
    }
